			...
			<thead>
				<tr>
					<th id="header1"><spring:theme
							code="text.account.orderHistory.orderNumber" text="Order Number" />
					</th>
					<th id="header2"><spring:theme
							code="text.account.orderHistory.orderStatus" text="Order Status" />
					</th>
					<th id="header3"><spring:theme
							code="text.account.orderHistory.datePlaced" text="Date Placed" />
					</th>
					<th id="header4"><spring:theme
							code="text.account.orderHistory.total" text="Total" /></th>
			...
			<tbody>
				<c:forEach items="${searchPageData.results}" var="order">
					<tr>
						...
						<td headers="header5"><c:set var="cancellable"
								value="${order.cancellable}" scope="request" /> <c:set
								var="orderCode" value="${order.code}" scope="request" /> <action:actions
