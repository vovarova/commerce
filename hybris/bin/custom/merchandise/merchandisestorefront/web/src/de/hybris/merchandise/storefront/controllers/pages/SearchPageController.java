...
public class SearchPageController extends AbstractSearchPageController
{
	...
	/*
	 * private static final boolean t = false; private static final String msg = "searchEmpty";
	 */
			...
			final HttpServletRequest request, final Model model) throws CMSItemNotFoundException
	{
		...
		{
			final PageableData pageableData = null/* = createPageableData(0, getSearchPageSize(), null, ShowMode.Page) */;
			...
			/*
			 * System.out.println("Hello"); System.out.println("Hello66"); sayHello(msg); sayHello1(); new Z().doSmth();
			 */
			//System.out.println("Hello");
			if /* (t) */ (searchPageData == null)
			{
