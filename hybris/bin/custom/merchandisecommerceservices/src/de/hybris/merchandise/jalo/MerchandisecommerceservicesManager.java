...
public class MerchandisecommerceservicesManager extends GeneratedMerchandisecommerceservicesManager
{
	...
	private static final Logger LOG = Logger.getLogger(MerchandisecommerceservicesManager.class.getName());
	...
	{
		return (MerchandisecommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MerchandisecommerceservicesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MerchandisecommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
