...
/**
 * This is the extension manager of the Merchandisecheckoutaddon extension.
 */
public class MerchandisecheckoutaddonManager extends GeneratedMerchandisecheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MerchandisecheckoutaddonManager.class.getName());
	 ...
	 */
	public static MerchandisecheckoutaddonManager getInstance()
	{
		return (MerchandisecheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MerchandisecheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MerchandisecheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MerchandisecheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MerchandisecheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MerchandisecheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
