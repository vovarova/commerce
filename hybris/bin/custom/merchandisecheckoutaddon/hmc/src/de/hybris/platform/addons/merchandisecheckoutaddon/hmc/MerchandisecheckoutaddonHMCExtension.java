 ...
 *  
 */
package de.hybris.platform.addons.merchandisecheckoutaddon.hmc;
...
/**
 * Provides necessary meta information about the merchandisecheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.4.0.6
 */
public class MerchandisecheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(MerchandisecheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.addons.merchandisecheckoutaddon.hmc.locales";
